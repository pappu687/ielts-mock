<x-backend-layout>
            ...
            <div class="col-12">
                <div class="card custom-card">
                    <div class="card-header justify-content-between p-3">
                        <div class="card-title">Listening Assessments</div>
                    </div>
                    <div class="card-body">
                        <table id="listening-assessments-table" class="table table-bordered w-100 table-striped my-3 border-bottom">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>User</th>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="editScoreOffcanvas" aria-labelledby="editScoreOffcanvasLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="editScoreOffcanvasLabel">Edit Listening Score</h5>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                const table = $('#listening-assessments-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: '{{ route('admin.listening-assessments.scores') }}',
                        type: 'GET'
                    },
                    columns: [
                        { data: 'id', name: 'id' },
                ...
                $('#listening-assessments-table').on('click', '.edit-score-btn', function() {
                ...
                $('#editScoreForm').on('submit', function(e) {
                    ...
                    const url = '{{ route('admin.listening-assessments.update-score', ':id') }}'.replace(':id', id);
